...
- **.Rmd File**: The R Markdown file contains the complete analysis, including data cleaning, exploratory data analysis, modeling, and results. It is an interactive document that integrates code and narrative text, making it easy to reproduce and understand the analysis.

- **CSV File**: This file contains the raw data used for analysis. It includes various health-related and demographic variables such as age, sex, marital status, income, race, waist circumference, BMI, albuminuria, urinary albumin-to-creatinine ratio (UrAlbCr), uric acid, blood glucose, HDL cholesterol, and triglycerides.

- **HTML File**: The HTML file is the rendered output of the R Markdown document. It provides a visually appealing and easy-to-navigate presentation of the analysis and results. This file can be viewed in any web browser.
